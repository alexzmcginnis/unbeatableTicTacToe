...
Board.prototype.openSquare = function (square){ //see if a square is open
  return square === '_';
}
...
//need to call minimax on every open square and return the score for that.  if the maximizer, want the max score. if the minimizer, want minin.  recursive call if the open square does not return a terminal case
